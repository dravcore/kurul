...
| `[-]` Further UI language packs                        | The resolution mechanism shipped post-MVP ([ADR 0018](decisions/0018-localization-strategy.md)). What remains is a second locale — `SUPPORTED_LOCALES`, `messages/tr.json`, API seed names, and translatable mail templates                                                                                            |
