...
| `version` | e.g. `"0.4.1"`       | The `@kurul/api` package version this build came from |
...
```text
LOG [TelemetryService] TELEMETRY_ENABLED is on — sending {"event":"instance_started","version":"0.4.1"} to https://…
```
