...
| [0031](0031-api-versioning.md)                         | API Versiyonlama: 1.0'da Tanıtılan Bir `/v1` URI Öneki ve Şeylerin Gönderilme Sırası                                 | Kabul edildi                                          | 2026-08-23 |
...
| [0034](0034-hosted-billing-and-plan-assignment.md)     | Barındırılan Faturalandırma ve Plan Ataması: Bir Merchant of Record, Tek Subscription Satırı, Yapılandırılmazsa Atıl | Önerildi                                              | 2026-08-26 |
