...
Her satır, [Ideas](https://github.com/dravcore/kurul/discussions/categories/ideas) altındaki
bir discussion'a bağlanıyor; orada oylanabilir ve tartışılabilir. Buradaki hiçbir şey oya göre
sıralanmıyor — planlanmamış bir satır planlanmamış kalır — ama arkasında insan olan ve somut
bir kullanım senaryosu iliştirilmiş bir satır, bir kalemi bu listeden çıkaran tek şeydir; o da
burada birikir.

| Madde                                                                                             | Not                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `[-]` [Geniş E2E suite (Playwright)](https://github.com/dravcore/kurul/discussions/262)           | Smoke paketi **geldi** ve kapsadığı özelliklerle birlikte büyüdü — bugün yedi senaryo: sürükleme kalıcılığı, realtime, e-postayla davet, bildirim yönlendirmesi, ek yükleme, Trello import'u, ve 360px'te dokunmatik board ([testing.md](testing.md#browser-uçtan-uca)). Stack'in kendisinin dağılabileceği akışların ötesine genişletmek planlanmadı                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `[-]` [Gantt / timeline view](https://github.com/dravcore/kurul/discussions/251)                  | `dueDate` + `estimatedMinutes` bunun için ayrı tutuluyor                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `[-]` [Task attachments](https://github.com/dravcore/kurul/discussions/263)                       | **Geldi** — kartta dosya ve bağlantı, bir depolama port'unun arkasında yerel diskte ([ADR 0022](decisions/0022-attachment-storage.md), [ADR 0024](decisions/0024-attachment-kinds-and-serving-policy.md)). Ertelenen kısımlar: object storage, imzalı paylaşım bağlantıları ve workspace başına kota — her biri kendi tetikleyicisine                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `[-]` [Board templates](https://github.com/dravcore/kurul/discussions/252)                        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `[-]` [Public API tokens + `/v1` prefix](https://github.com/dravcore/kurul/discussions/253)       | 1.0 sonrası; artık yalnızca adlandırılmış değil, kapsamı da yazılı — [API 1.0](#api-10). Versiyonlama politikası: [api-conventions.md](api-conventions.md#versiyonlama)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `[-]` [Webhooks](https://github.com/dravcore/kurul/discussions/254)                               | 1.0 sonrası. Kapsam üç olay, daha fazlası değil — [API 1.0](#api-10)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `[-]` [E-posta bildirimleri](https://github.com/dravcore/kurul/discussions/255)                   | Transactional SMTP zaten var ([ADR 0013](decisions/0013-invitation-email-verification.md)); kalan, `Notification` satırlarını ona yönlendirmek                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `[-]` [Trello / Jira import](https://github.com/dravcore/kurul/discussions/256)                   | **Trello geldi, Jira başlamadı.** Bir board'un JSON export'u board'a dönüşüyor — list'ler, kart'lar, label'lar, checklist'ler; attachment'lar bağlantı olarak. Tek yönlü, idempotan değil, üye eşlemesi yok, yorum yok, ve içe aktarılan her kolon `UNSTARTED` geliyor ([ADR 0025](decisions/0025-trello-import-mapping.md)). Üretilmiş 500 kartlık bir export, beş koşuda medyan **572.9 ms** (p95 **655.8 ms**) ile içe aktarıldı — Apple M3 Max üzerinde, loopback'teki bir API ve Postgres'e karşı; arada ters proxy, konteyner ya da ağ yok. Yani bunu bir dağıtım rakamı değil, bir taban olarak okuyun. **Şema uyumu hiçbir gerçek Trello export'una karşı ölçülmedi** — elde gerçek export olmadığı için fikstürler sentetik — yani okuyucunun kırılma ihtimali en yüksek yer ilk gerçek export; okuyucunun hata yerine rapor döndürmesinin sebebi bu. Jira'nın henüz bir tasarım kaydı yok |
| `[-]` [Ek UI dil paketleri](https://github.com/dravcore/kurul/discussions/257)                    | **Türkçe geldi.** `SUPPORTED_LOCALES` artık `['en', 'tr']`, `messages/tr.json` 486 key'in hepsini taşıyor, board'lar `Yapılacak / Devam Ediyor / Bitti` ile tohumlanıyor ve iki transactional e-posta da alıcının dilinde yazılıyor ([ADR 0018](decisions/0018-localization-strategy.md)). `messages/catalog.test.ts`, bir katalogda olup diğerinde olmayan bir key'de build'i düşürür; yani "%100" bir iddia değil, bir kapı. Bu satırın hâlâ adlandırdığı şey **üçüncü** dil: yeni bir mekanizma gerekmiyor — bir katalog dosyası, `SEED_COLUMN_NAMES` içinde bir satır ve `MAIL_COPY` içinde bir satır; ikisi de `Record<Locale, …>` ve ikisi de var olana kadar compile error. Gereken tek şey bir çevirmen                                                                                                                                                                                     |
| `[-]` [Docker Compose ötesi self-host rehberi](https://github.com/dravcore/kurul/discussions/258) |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `[-]` [Due-soon teslim alternatifleri](https://github.com/dravcore/kurul/discussions/259)         | Nest interval scanner veya OS cron → internal HTTP                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `[-]` [Üye picker’sız mention’lar](https://github.com/dravcore/kurul/discussions/260)             | Düz `@DisplayName` veya API-only `mentionedUserIds[]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `[-]` [Activity feed realtime push](https://github.com/dravcore/kurul/discussions/261)            | Bell zaten `notification:unread-changed` alıyor; task activity hâlâ panel açılışında yükleniyor                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
