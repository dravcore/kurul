...
sayfa sayım hiç kıpırdamadan ikisinden birden birkaç tane taşıyabilir: P4'ün auth ekranlarının
(rail hiç yokken kendi damga mark'ının yanında iki üç copper link) ve P7'nin settings
ekranlarının (sidebar wordmark'ının mark'ı, o ekranın rail veya button'a zaten harcadığının
yanında) onları zaten böyle saydığı gibi.
