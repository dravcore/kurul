...
| `test:browser`   | `pnpm test:browser`   | E2e stack'ini derler (`e2e/build-stack.mjs`) ve Playwright smoke paketini ona karşı çalıştırır. Docker ister; CI'da bunu PR kapısı değil nightly workflow çalıştırır. Bkz. [testing.md](testing.md#browser-uçtan-uca)                                                                                                                                                                                                                                                                                                                                                                        |
