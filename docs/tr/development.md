...
| `INSTANCE_ADMIN_EMAILS`               | _(boş)_                                                             | Kurulum genelindeki [aktivasyon hunisini](#aktivasyon-hunisi-ve-telemetri) okumasına **ve bir başkasının hesabı için silme talebini uygulamasına** (`DELETE /instance/users/:userId`, [ADR 0026](decisions/0026-account-deletion-anonymisation.md)) izin verilen, virgülle ayrılmış adresler. **Boş, hiç kimse demektir** — makinedeki her workspace'in sahibi olan hesap dahil |
