...
| Header              | Value                                                                      |
| ------------------- | -------------------------------------------------------------------------- |
| `X-Kurul-Signature` | `v1=<hex>`, the scheme prefixed so a second scheme can be added beside it  |
...
one valid for 24 hours, so a receiver can be updated without a missed delivery. There is no reveal:
