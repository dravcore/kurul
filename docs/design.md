...
| [roadmap.md](archive/roadmap-mvp-phases.md#phase-3--boards-and-columns) | Phase 3 lands tokens, shell, and board chrome; Phase 4 the drag interaction and detail panel; Phase 5 priority and label rendering; Phase 7 the charts            |
