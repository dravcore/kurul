      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="mx-auto flex w-full max-w-[720px] flex-col gap-8">
          {/* Members first: it is the only section that is about other people, and the one a
              new workspace owner is on this screen to find. Its own controls moved to
              /settings/members: the section reached its own data-table scale (invite dialog,
              pending invitations, seat usage, a role control per row), and three of the
              sections below it are one control each. */}
          <SettingsSection title={t('members.title')} description={t('members.description')}>
            <Button asChild variant="outline" className="self-start">
              <Link href="/settings/members">{t('members.manageAction')}</Link>
            </Button>
          </SettingsSection>
