...
cd kurultay
cp .env.example .env   # set BETTER_AUTH_SECRET and POSTGRES_PASSWORD (openssl rand -base64 32)
pnpm install
...
hand; see [docs/development.md#database-and-cache-credentials](docs/development.md#database-and-cache-credentials).
