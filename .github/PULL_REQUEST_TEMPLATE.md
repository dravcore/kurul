<!-- Keep it small: single responsibility, ~500 LOC guideline. See CONTRIBUTING.md. -->
...
- [ ] I understand that Kurultay does not merge outside code, documentation, or translation
      ...
      [ADR 0015](https://github.com/dravcore/kurultay/blob/develop/docs/decisions/0015-no-external-contributions.md)).
      There is nothing to sign: the
      [CLA](https://github.com/dravcore/kurultay/blob/develop/docs/cla.md) is an unenacted draft
